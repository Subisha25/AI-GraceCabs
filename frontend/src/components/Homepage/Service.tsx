...
const details = [
  "The Fleet Management division of New Local AI Mobility Platform manages approx 400 Vehicles: 150 company-owned and 250 associate vehicles. Includes 135 Sedan cabs, 75 SUVs, 130 LMVs, 60 Buses. Fleet equipped with GPS tracking, communication & information system.",
