...
export default function AddCompany() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await axiosInstance.post("/organizations", form);
      showToast("Organization saved successfully!", "success");
      navigate("/organizations");
    } catch (error: any) {
      const msg = error.response?.data?.message || "Failed to save organization. Please try again.";
      showToast(msg, "error");
    } finally {
      setSubmitting(false);
    }
    ...
    <PageLayout>
      ...
      <main className="py-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Register a corporate or institutional organization on the platform</p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    value={form.type}
                    onChange={handleInputChange}
                    className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 h-[42px]"
                  >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  value={form.address}
                  onChange={handleInputChange}
                  className="w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 resize-none"
                />
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 disabled:opacity-70"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 resize-none disabled:opacity-70"
                />
              </div>
            </div>
          </div>
